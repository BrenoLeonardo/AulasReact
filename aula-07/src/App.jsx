  ...
  return (
    <Container className="bg-secondary">
      ...
      <Stack>
       ...
       {/* <h1><FaReact/> APX JSX</h1>
      <FaLinkedin/>
      <Button variant="danger" className="me-2 mt-3">CLIQUE AQUI</Button>
      <button type="button" class="btn btn-danger">Primary</button> */}

      {/* <Row style={{backgroundColor: "darkgoldenrod", padding: 30}}>
        <Col style={{backgroundColor: "white",borderColor: "black"}}>12COLUNA</Col>
      </Row>
      <Row style={{backgroundColor: "darkgoldenrod", padding: 30}}>
        <Col md={9} style={{backgroundColor: "lightgray"}}>9COLUNA</Col>
        <Col md={3} style={{backgroundColor: "white"}}>3COLUNA</Col>
      </Row>
      <Row style={{backgroundColor: "darkgoldenrod", padding: 30}}>
        <Col md={8} style={{backgroundColor: "lightgray"}}>8COLUNA</Col>
      </Row>
      <Row style={{backgroundColor: "darkgoldenrod", padding: 30}}>
        <Col sm={12} md={12} lg={4} xl={3} style={{backgroundColor: "lightgray", height: 100}}>3COLUNA</Col>
        <Col sm={12} md={12} lg={4} xl={3} style={{backgroundColor: "white", height: 100}}>3COLUNA</Col>
        <Col sm={12} md={12} lg={4} xl={3} style={{backgroundColor: "lightgray", height: 100}}>3COLUNA</Col>
        <Col sm={12} md={12} lg={4} xl={3} style={{backgroundColor: "white", height: 100}}>3COLUNA</Col>
      </Row> */}
